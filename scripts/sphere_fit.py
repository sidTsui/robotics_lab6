...
def build_matrices(data_points,matrix_a, matrix_b):
...
def fit(matrix_a, matrix_b):
	...
	try: 
		##used to find P
		P = np.linalg.lstsq(A, B, condition = None)[0]
...
if __name__ == '__main__':
	...
	img_sub = rospy.Subscriber("/xyz_cropped", XYZarray, build_matrices, (matrix_a, matrix_b)) 
